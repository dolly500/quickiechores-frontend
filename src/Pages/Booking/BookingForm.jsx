...
const BookingForm = ({ service, onBack, onBookingSuccess }) => {
  ...
  const validateStep1 = () => {
    const { bookingDate, startTime, endTime } = formData;
  ...
  const validateStep2 = () => {
    ...
    // Optional: Add validation for postal code format if needed
      ...
      if (err.response?.status === 401) {
        ...
        if (newToken) {
          try {
            ...
            setError(retryErr.response?.data?.message || 'Failed to create booking after token refresh');
          }
        } else {
          localStorage.removeItem('token');
          setToken('');
      ...
      <div style={styles.confirmationCard}>
        ...
        <div style={styles.bookingDetails}>
          ...
          <div style={styles.detailRow}>
            ...
            <span style={styles.detailValue}>
              {formData.serviceLocation.address}, {formData.serviceLocation.city}, {formData.serviceLocation.postalCode}
            </span>
          </div>
          ...
          <div style={styles.detailRow}>
            ...
            <span style={styles.detailValue}>
              {formData.paymentMethod.charAt(0).toUpperCase() + formData.paymentMethod.slice(1).replace('_', ' ')}
            </span>
          </div>
        </div>
        ...
        <div style={styles.totalSection}>
          <div style={styles.totalRow}>
            ...
            <span style={styles.totalValue}>{formatPrice(calculateTotalPrice())}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <div style={styles.progressBar}>
          <div style={styles.progressStep}>
            <div style={{ ...styles.progressDot, ...(step >= 1 ? styles.progressDotActive : {}) }}>1</div>
            <span style={styles.progressLabel}>Time</span>
          </div>
          <div style={styles.progressLine}></div>
          <div style={styles.progressStep}>
            <div style={{ ...styles.progressDot, ...(step >= 2 ? styles.progressDotActive : {}) }}>2</div>
            <span style={styles.progressLabel}>Details</span>
          </div>
          <div style={styles.progressLine}></div>
          <div style={styles.progressStep}>
            <div style={{ ...styles.progressDot, ...(step >= 3 ? styles.progressDotActive : {}) }}>3</div>
      ...
      <div style={styles.formContainer}>
        <div style={styles.serviceHeader}>
          ...
          <p style={styles.subtitle}>Base price: {formatPrice(service.price)}/hour</p>
        </div>
